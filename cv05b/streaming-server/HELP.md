...
* The original package name 'cz.vutbr.feec.utko.bpc-mds.streaming-server' is invalid and this project uses 'cz.vutbr.feec.utko.bpcmds.streamingserver' instead.
